...
my_set = set(my_list)
my_list = list(my_set) # replace the code to the left
...
my_other_tuple = (my_new_tuple[0:6]) # replace the code to the left
...
if(my_other_tuple in my_list):
   tuple_and_list_comp = True
else:
   tuple_and_list_comp = False # replace the code to the left
...
my_al_list = [word_dict['a']['apple'],word_dict['a']['ant'], word_dict['b']['bad'],word_dict['b']['business']] # replace the code to the left
